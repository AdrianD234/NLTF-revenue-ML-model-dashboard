...
def main() -> int:
    parser = argparse.ArgumentParser(description="Export the Heavy RUC fixed-finalist forward-scorer audit.")
    ...
    record = json_record(evaluate_heavy_ruc_forward_scorer(args.repo_root))
