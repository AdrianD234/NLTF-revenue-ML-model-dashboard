...
drop-downs over the eleven governed states, so this script runs the reference
...
One hundred and twenty-one states per engine (eleven Current x eleven
...
exactly eleven centres are computed per engine, never one hundred and
twenty-one.
