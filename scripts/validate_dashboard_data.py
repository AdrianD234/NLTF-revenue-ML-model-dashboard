...
def main() -> int:
    ...
    report = "\n".join(
        [
            ...
            f"Status: **{status}**.",
            "",
            "Primary Parquet validation is authoritative for dashboard completion.",
            "Legacy run-folder CSV/XLSX outputs are review-only and are not the main app data source.",
            "",
            *findings,
            "",
        ]
