...
def test_dashboard_interaction_performance(page: Page) -> None:
    ...
    expect(page.get_by_text("Page 1 of 4 - Executive Summary").first).to_be_visible(timeout=90000)
    ...
    for label, expected in [
        ("Model Confidence", "Page 2 of 4 - Model Confidence"),
        ("Scenario Forecasts", "Page 3 of 4 - Scenario Forecasts"),
        ("Revenue Outlook", "Page 4 of 4 - Revenue Outlook"),
        ("Executive Summary", "Page 1 of 4 - Executive Summary"),
    ]:
        t0 = time.perf_counter()
