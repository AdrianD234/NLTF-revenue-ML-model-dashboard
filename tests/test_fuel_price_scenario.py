...
def test_fixed_finalist_replay_preserves_base_and_orders_governed_conflict_paths(
    ...
    assert len(expected_scenarios) == 52
...
def test_policy_replay_builds_fifty_two_paths_with_formula_closed_net_ruc(
    fuel_replay,
) -> None:
    validation = fuel_replay.policy_validation_report.set_index("scenario_name")
...
def test_ar1_pack_replays_fifty_two_paths_and_retains_source_lineage(
    ar1_fuel_replay,
) -> None:
