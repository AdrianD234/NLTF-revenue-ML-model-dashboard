...
def test_forecast_builder_upload_validate_calculate_and_download(page: Page) -> None:
    ...
    expect(body).to_contain_text("failed_repo_history_component_replay", timeout=90000)
    expect(body).to_contain_text("HEAVY_RUC__schiff__GBR_learning_rate0_06_max_depth1_n_estimators650__noylag__w64", timeout=90000)
